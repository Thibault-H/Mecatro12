...
public class Quaternion implements TesteurNullite{
	...
	public static final Quaternion un = new Quaternion(1,0,0,0);
	...
	public String toString() {
		...
		p0=p1=p2=p3= "";
		if (!TesteurNullite.estNul(valeur[0]))
			p0= valeur[0]+"  + ";
		if (!TesteurNullite.estNul(valeur[1]))
			p1= valeur[1]+" i + ";
		if (!TesteurNullite.estNul(valeur[2]))
			p2= valeur[2]+" j + ";
		if (!TesteurNullite.estNul(valeur[3]))
			p3= valeur[3] + " k + ";
		result = p0 + p1+p2+p3;
